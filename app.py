...
from recommendation import generate_learning_recommendations
    ...
    if st.button("🚀 Analyze Candidate Profile"):
        if not resume_text:
            ...
            with st.spinner("Running deep NLP analysis..."):
                ...
                strong_id = analysis['strongest_cluster']
                strong_skills = set([skill for skill, count in analysis['cluster_analysis'][strong_id]['skill_frequencies'].most_common(20)])
                missing_skills = list(strong_skills - set(all_skills))
                recs = generate_learning_recommendations(missing_skills)
            ...
            with col1:
                ...
                st.markdown(f"<p style='color: #A0AEC0;'>Assigned to: <b style='color: white;'>Cluster {cluster_pred}</b></p>", unsafe_allow_html=True)
                
                st.markdown("<hr style='border-color: rgba(255,255,255,0.1);'>", unsafe_allow_html=True)
                st.markdown("<b>Languages & Databases:</b><br>", unsafe_allow_html=True)
                ...
                st.markdown("<br><b>Frameworks & Tools:</b><br>", unsafe_allow_html=True)
            ...
            with col2:
                ...
                if cluster_pred == strong_id:
                    st.markdown("""
                    <div class="rec-item" style="border-left-color: #00E5FF;">
                        ✨ <b>Top Tier Profile!</b> You are in the strongest cluster. Focus on building highly advanced projects and leading open-source initiatives.
                    </div>
                    """, unsafe_allow_html=True)
                else:
                ...
                st.markdown("<br><p style='color: #A0AEC0; font-size: 0.9rem;'><i>* Recommendations are generated by comparing the candidate's profile against the highest performing cluster in the dataset.</i></p>", unsafe_allow_html=True)
